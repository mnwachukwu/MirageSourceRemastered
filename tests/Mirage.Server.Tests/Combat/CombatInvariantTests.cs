...
public class CombatInvariantTests
{
    ...
    public void CasterDeathReagentLoss_ScalesWithTierAndWearPercent()
    {
        ...
        int normal = CombatFormulas.CasterDeathReagentLoss(tierData1: 100, wearPercent: 10);
        ...
        Assert.That(CombatFormulas.CasterDeathReagentLoss(tierData1: 0, wearPercent: 10), Is.EqualTo(0));   // no tier
    }
}
